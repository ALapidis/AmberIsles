...
public class Weapon : Equipment
{
	...
	public Weapon(string itemName, string description, ItemType itemType, Quality quality, string spriteNeutral, string spriteHighlighted, int maxSize, int strength, int endurance, int dexterity, int intellect, int willpower, int charisma, int luck, float attackSpeed)
		: base(itemName, description, itemType, quality, spriteNeutral, spriteHighlighted, maxSize, strength, endurance, dexterity, intellect, willpower, charisma, luck)
    {
