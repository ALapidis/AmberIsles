...
public class RewardExperiencePoints : MonoBehaviour {
	...
	//private void DidPlayerLevelUp() {
	//	if(ActivePlayerCharacter.CurrentXp >= ActivePlayerCharacter.RequiredXp) {
	//		LevelUp();
	//	}
	//}

	//private void LevelUp() {
	//	if(ActivePlayerCharacter.CurrentXp > ActivePlayerCharacter.RequriedXp) {
	//		ActivePlayerCharacter.CurrentXp -+ ActivePlayerCharacter.RequiredXp;
	//	} else {
	//		ActivePlayerCharacter.CurrentXp = 0;
	//	}
	//}
